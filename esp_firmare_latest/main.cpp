...
int main(void) {
    // Initialize Arduino hardware (timers, ADC, etc.)
    init();
...
void loop() {
    ...
    if (NICE_IMU::readData(rf_IMUData, sizeof(rf_IMUData))) {
        Serial.print(rf_IMUData[0]);
        Serial.print(',');
        Serial.print(rf_IMUData[1]);
        Serial.print(',');
        Serial.print(rf_IMUData[2]);
        Serial.print(',');
        Serial.print(rf_IMUData[3]);
        Serial.print(',');
        Serial.print(rf_IMUData[4]);
        Serial.print(',');
        Serial.print(rf_IMUData[5]);
        Serial.println();
        BLE::sendData((uint8_t *)rf_IMUData, sizeof(rf_IMUData));
    }
}
